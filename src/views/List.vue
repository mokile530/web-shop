		...
		<div class="item-box">
			<ul class="frame">
				<li class="item" v-for="item in list" :key="item._id">
					...
					<el-button class="buy" type="primary">立即购买</el-button>
					<el-button class="into-cart" type="danger">加入购物车</el-button>
				</li>
			</ul>
		</div>
		<!-- 页码 -->
		<el-pagination class="page-number" background="" layout="total,prev, pager, next,jumper"  :page-size="15" :total="allCount" @current-change="handleCurrentChange"></el-pagination>
	</div>
</template>
